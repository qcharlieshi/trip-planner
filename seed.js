    ...
    activities: [
      ...
      day: [
        {date: Date(), hotels: [{name: "Andaz Wall Street", place: {address: "75 Wall St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.705137, -74.007624]}, num_stars: 4, amenities: "Pool, Free Wi-Fi" }],
            restaurants: [{name: "FASKESHIT", place: {address: "56 shit", city: "New York", state: "NY", phone: "123-456-7890", location: [40.705137, -74.013940]}, cuisine: "French", price: 4}],
        ...
        {date: Date(), hotels: [{name: "Andaz Wall Street", place: {address: "900 fack", city: "New York", state: "NY", phone: "123-456-7890", location: [40.705137, -74.007624]}, num_stars: 4, amenities: "Pool, Free Wi-Fi" }],
            restaurants: [{name: "OTHERFASKESHIT", place: {address: "woepijvowipjev", city: "New York", state: "NY", phone: "123-456-7890", location: [40.705137, -74.013940]}, cuisine: "French", price: 4}],
            activity: [{name: "Mahayana Temple Buddhist Association", place: {address: "133 Canal St", city: "New York", state: "NY", phone: "123-456-7890", location: [40.716291, -73.995315]}, age_range: "All" }]}
    ]
};
...
db.sync({force: true})
    .then(function () {
        ...
        const creatingDay = Promise.map(data.day, function(day) {
            return Day.create(day, {include: [Hotel, Restaurant, Activity]});
        });
